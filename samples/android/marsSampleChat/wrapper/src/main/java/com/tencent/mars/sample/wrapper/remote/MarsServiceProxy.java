...
import com.tencent.marsMulti.app.AppLogic;
...
public class MarsServiceProxy implements ServiceConnection {
    ...
    public static final String SERVICE_DEFAULT_CLASSNAME = "com.tencent.marsMulti.sample.wrapper.service.MarsServiceNative";
    ...
    public void setForeground(boolean isForeground) {
        try {
            if (service == null) {
                Log.d(TAG, "try to bind remote marsMulti service, packageName: %s, className: %s", gPackageName, gClassName);
                ...
                if (!gContext.bindService(i, inst, Service.BIND_AUTO_CREATE)) {
                    Log.e(TAG, "remote marsMulti service bind failed");
                }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder binder) {
        Log.d(TAG, "remote marsMulti service connected");
    ...
    public void onServiceDisconnected(ComponentName componentName) {
        ...
        // TODO: need reconnect ?
        Log.d(TAG, "remote marsMulti service disconnected");
    }
    ...
    private void cancelSpecifiedTaskWrapper(MarsTaskWrapper marsTaskWrapper) {
        if (queue.remove(marsTaskWrapper)) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "cancel marsMulti task wrapper in client, should not catch RemoteException");
            }
            ...
            try {
                ...
                e.printStackTrace();
                Log.w(TAG, "cancel marsMulti task wrapper in remote service failed, I'll make marsTaskWrapper.onTaskEnd");
            }
        }
    }
