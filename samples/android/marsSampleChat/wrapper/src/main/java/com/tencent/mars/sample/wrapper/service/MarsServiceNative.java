...
import com.tencent.marsMulti.Mars;
...
public class MarsServiceNative extends Service implements MarsService {
    ...
    public void onCreate() {
        ...
        //
        Log.d(TAG, "marsMulti service native created");
    }

    @Override
    public void onDestroy() {
        Log.d(TAG, "marsMulti service native destroying");

        // Leave Mars
        Mars.onDestroy();
        // ContentDistributionNetwork.onDestroy();

        Log.d(TAG, "marsMulti service native destroyed");
        super.onDestroy();
    }
