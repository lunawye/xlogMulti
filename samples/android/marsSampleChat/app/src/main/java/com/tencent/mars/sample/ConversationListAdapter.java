...
import com.tencent.marsMulti.sample.databinding.ItemConversationBinding;
...
public class ConversationListAdapter extends RecyclerView.Adapter<ConversationListAdapter.BindingHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(BindingHolder holder, int position) {
        ...
        holder.binding.setVariable(com.tencent.marsMulti.sample.BR.conversation, conversation);
