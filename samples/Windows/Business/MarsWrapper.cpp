...
{
	com::tencent::marsMulti::sample::chat::proto::MessagePush msg;
...
void MarsWrapper::start()
{
	...
	NetworkService::Instance().setPushObserver(com::tencent::marsMulti::sample::proto::CMD_ID_PUSH, this);
}
...
void MarsWrapper::pingServer(const std::string& _name, const std::string& _text, boost::weak_ptr<HelloCGICallback> _callback)
{
	...
	task->cmdid_ = com::tencent::marsMulti::sample::proto::CMD_ID_HELLO;
	task->cgi_ = "/marsMulti/hello";
	task->host_ = g_host;
...
void MarsWrapper::sendChatMsg(const ChatMsg& _chat_msg)
{
	...
	task->cmdid_ = com::tencent::marsMulti::sample::proto::CMD_ID_SEND_MESSAGE;
	task->cgi_ = "/marsMulti/sendmessage";
	task->host_ = g_host;
...
void MarsWrapper::getConversationList(boost::weak_ptr<GetConvListCGICallback> _callback)
{
	...
	task->cmdid_ = com::tencent::marsMulti::sample::proto::CMD_ID_CONVERSATION_LIST;
	task->cgi_ = "/marsMulti/getconvlist";
	task->host_ = g_host;
	task->access_token_ = "";
	task->callback_ = _callback;
	NetworkService::Instance().startTask(task);
