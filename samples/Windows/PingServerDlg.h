...
# include "marsMulti/boost/enable_shared_from_this.hpp"
#include <string>
...
public:
	...
	virtual void OnResponse(HelloCGITask* task, const com::tencent::marsMulti::sample::proto::HelloResponse& response);
	virtual void OnResponse(GetConvListCGITask* task, const com::tencent::marsMulti::sample::proto::ConversationListResponse& response);
