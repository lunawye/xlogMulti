...
#import <marsMulti/comm/autobuffer.h>
#import <marsMulti/xlog/qm_xlogger.h>
#import <marsMulti/stn/stn.h>
...
int StnCallBack::Buf2Resp(uint32_t _taskid, void* const _user_context, const std::string& _user_id, const AutoBuffer& _inbuffer, const AutoBuffer& _extend, int& _error_code, const int _channel_select) {
    ...
    int handle_type = marsMulti::stn::kTaskFailHandleNormal;
    ...
    if (errorCode != 0) {
        handle_type = marsMulti::stn::kTaskFailHandleDefault;
    }
...
void StnCallBack::ReportConnectStatus(int _status, int longlink_status) {
    ...
    switch (longlink_status) {
        case marsMulti::stn::kServerFailed:
        case marsMulti::stn::kServerDown:
        case marsMulti::stn::kGateWayFailed:
            break;
        case marsMulti::stn::kConnecting:
            break;
        case marsMulti::stn::kConnected:
            break;
        case marsMulti::stn::kNetworkUnkown:
            return;
        default:
            return;
    }
