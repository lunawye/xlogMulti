...
#import <marsMulti/app/app_logic.h>
#import <marsMulti/baseevent/base_logic.h>
#import <marsMulti/xlog/qm_xlogger.h>
#import <marsMulti/xlog/qm_xloggerbase.h>
#import <marsMulti/xlog/qm_appender.h>
...
- (int)startTask:(CGITask *)task ForUI:(id<UINotifyDelegate>)delegateUI {
    ...
    marsMulti::stn::StartTask(ctask);
    
    return ctask.taskid;
}

- (void)stopTask:(NSInteger)taskID {
    marsMulti::stn::StopTask((uint32_t)taskID);
}
