...
package com.tencent.marsMulti.proxy;

import com.tencent.marsMulti.logicserver.ProxySession;
import com.tencent.marsMulti.logicserver.TopicChats;
import com.tencent.marsMulti.sample.chat.proto.Chat;
import com.tencent.marsMulti.sample.proto.Main;
import com.tencent.marsMulti.utils.LogUtils;
...
public class NetMsgHeaderHandler extends ChannelInboundHandlerAdapter {
    ...
    static {
        CMD_PATH_MAP.put(Main.CmdID.CMD_ID_HELLO_VALUE, "marsMulti/hello");
        CMD_PATH_MAP.put(Main.CmdID.CMD_ID_SEND_MESSAGE_VALUE, "/marsMulti/sendmessage");
        CMD_PATH_MAP.put(Main.CmdID.CMD_ID_HELLO2_VALUE, "/marsMulti/hello2");
    }
