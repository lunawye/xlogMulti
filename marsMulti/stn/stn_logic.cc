...
#ifdef ANDROID
	marsMulti::baseevent::addLoadModule(kLibName);
...
bool (*ProxyIsAvailable)(const marsMulti::comm::ProxyInfo& _proxy_info, const std::string& _test_host, const std::vector<std::string>& _hardcode_ips)
= [](const marsMulti::comm::ProxyInfo& _proxy_info, const std::string& _test_host, const std::vector<std::string>& _hardcode_ips){
