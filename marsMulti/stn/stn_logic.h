...
//    extern void SetShortlinkSvrAddr(const uint16_t port);
    ...
    extern bool (*ProxyIsAvailable)(const marsMulti::comm::ProxyInfo& _proxy_info, const std::string& _test_host, const std::vector<std::string>& _hardcode_ips);
    ...
    //===----------------------------------------------------------------------===//
    ///
    /// Support multi longlinks for marsMulti
