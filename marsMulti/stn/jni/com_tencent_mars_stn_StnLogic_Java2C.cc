...
DEFINE_FIND_CLASS(KNetJava2C, "com/tencent/marsMulti/stn/StnLogic")
...
JNIEXPORT jobject JNICALL Java_com_tencent_mars_stn_StnLogic_getLoadLibraries
  (JNIEnv *_env, jclass clz) {
	...
	return marsMulti::baseevent::getLoadLibraries(_env);
}
 ...
 * Class:     com_tencent_mars_stn_StnLogic_Java2C
 * Method:    startTask
 * Signature: (Lcom/tencent/marsMulti/stn/StnLogic$Task;)V
 */
...
JNIEXPORT void JNICALL Java_com_tencent_mars_stn_StnLogic_setClientVersion
  (JNIEnv *_env, jclass, jint _client_version) {
	marsMulti::stn::SetClientVersion(_client_version);
}

JNIEXPORT jint JNICALL Java_com_tencent_mars_stn_StnLogic_genTaskID
(JNIEnv *_env, jclass) {
    return (jint)marsMulti::stn::GenTaskID();
}
}
