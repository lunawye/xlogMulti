...
#include "marsMulti/comm/compiler_util.h"
#include "marsMulti/comm/platform_comm.h"
#include "marsMulti/stn/stn.h"
#include "marsMulti/stn/task_profile.h"
#include "marsMulti/boost/signals2.hpp"

#ifndef NATIVE_CALLBACK
DEFINE_FIND_CLASS(KC2Java, "com/tencent/marsMulti/stn/StnLogic")
DEFINE_FIND_CLASS(KC2JavaStnCgiProfile,"com/tencent/marsMulti/stn/StnLogic$CgiProfile");
#endif
...
#ifndef NATIVE_CALLBACK
DEFINE_FIND_STATIC_METHOD(KC2Java_onTaskEnd, KC2Java, "onTaskEnd", "(ILjava/lang/Object;IILcom/tencent/marsMulti/stn/StnLogic$CgiProfile;)I")
#else
