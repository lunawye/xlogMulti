...
class LongLinkTaskManager {
  public:
    ...
    static boost::function<void (uint32_t _version, marsMulti::stn::TlsHandshakeFrom _from)> on_handshake_ready_;
    static boost::function<bool (int _error_code)> should_intercept_result_;

  public:
    LongLinkTaskManager(marsMulti::stn::NetSource& _netsource, comm::ActiveLogic& _activelogic, DynamicTimeout& _dynamictimeout, comm::MessageQueue::MessageQueue_t  _messagequeueid);
  ...
  private:
    ...
    void __OnHandshakeCompleted(uint32_t _version, marsMulti::stn::TlsHandshakeFrom _from);
