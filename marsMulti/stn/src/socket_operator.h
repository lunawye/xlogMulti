...
namespace marsMulti {
	namespace stn {
		...
		public:
			...
			virtual SOCKET Connect(const std::vector<socket_address>& _vecaddr, marsMulti::comm::ProxyType _proxy_type = marsMulti::comm::kProxyNone, const socket_address* _proxy_addr = NULL,
