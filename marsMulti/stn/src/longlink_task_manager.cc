...
boost::function<void (uint32_t _version, marsMulti::stn::TlsHandshakeFrom _from)> LongLinkTaskManager::on_handshake_ready_;
...
void LongLinkTaskManager::__OnHandshakeCompleted(uint32_t _version, marsMulti::stn::TlsHandshakeFrom _from) {
