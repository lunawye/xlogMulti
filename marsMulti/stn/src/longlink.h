...
#include "marsMulti/stn/src/net_source.h"
#include "marsMulti/stn/src/longlink_identify_checker.h"
...
class LongLink {
  ...
  public:
    ...
    boost::function< void (uint32_t _tls_version, marsMulti::stn::TlsHandshakeFrom _from)> OnHandshakeCompleted;
