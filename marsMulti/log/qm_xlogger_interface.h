...
marsMulti::comm::XloggerCategory* NewXloggerInstance(const XLogConfig& _config, TLogLevel _level);


marsMulti::comm::XloggerCategory* GetXloggerInstance(const char* _nameprefix);
