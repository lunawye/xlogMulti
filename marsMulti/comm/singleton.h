...
#define SINGLETON_INTRUSIVE(classname, creater, destoryer) \
    ...
    {\
      public:\
        ...
        static marsMulti::comm::Mutex& singleton_mutex() {static marsMulti::comm::Mutex s_mutex; return s_mutex;}\
     ...
     \
      public:\
        ...
        {\
            ...
            if (ret) return ret;\
            \
            marsMulti::comm::ScopedLock    lock(singleton_mutex());\
  ...
  private:
    ...
    class SingletonInstance {
      public:
        ...
        static marsMulti::comm::Mutex& singleton_mutex() {
            static marsMulti::comm::Mutex s_mutex;
            return s_mutex;
        }
    };
    ...
    class SingletonInfoImpl : public SingletonInfo {
      public:
        ...
        virtual void DoRelease() {
            marsMulti::comm::ScopedLock    lock(SingletonInstance<T>::singleton_mutex());
