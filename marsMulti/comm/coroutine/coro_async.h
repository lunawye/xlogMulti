...
private:
    struct Wrapper_ {
        marsMulti::comm::Mutex mutex;
        marsMulti::comm::mq::MessagePost_t message_timeout;
        marsMulti::comm::mq::MessagePost_t message_running;
...
public:
    ...
    operator ()(const F& _block_func, int64_t _timeout = -1, int* _status = NULL) {
        ...
        marsMulti::comm::ScopedLock lock(wrapper_->mutex);
        ...
        marsMulti::comm::mq::AsyncResult<R> async_result(_block_func, [wrapper, result](const R& _result, bool _valid) {
            
            ASSERT(_valid);
            
            marsMulti::comm::ScopedLock lock(wrapper->mutex);
            *result = _result;
            if (!wrapper->wrapper) return;
            if (marsMulti::comm::mq::KNullPost != wrapper->message_running)  { return; }
            if (marsMulti::comm::mq::KNullPost == wrapper->message_timeout
                || marsMulti::comm::mq::CancelMessage(wrapper->message_timeout)){
    ...
    operator ()(const F& _block_func, int64_t _timeout = -1, int* _status = NULL) {
        ...
        marsMulti::comm::mq::AsyncResult<void> async_result(_block_func, [wrapper](bool _valid) {
    ...
    void Cancel() const {
        ...
        if (marsMulti::comm::mq::KNullPost != wrapper_->message_running)  { return; }
        if (marsMulti::comm::mq::KNullPost == wrapper_->message_timeout
            || marsMulti::comm::mq::CancelMessage(wrapper_->message_timeout)){
...
typename boost::result_of< F()>::type MessageInvoke(const F& _func) {
    ...
    typedef typename boost::result_of<F()>::type R;
    marsMulti::comm::mq::AsyncResult<R> result(
                              [_func, wrapper](){
                                Resume(wrapper);
                                return _func();
                              });
    
    marsMulti::comm::mq::AsyncInvoke(result, marsMulti::comm::mq::Post2Handler(marsMulti::comm::mq::RunningMessageID()));
    Yield();
