...
#define ASYNC_BLOCK_START marsMulti::comm::MessageQueue::AsyncInvoke([=] () {
...
if (marsMulti::comm::MessageQueue::CurrentThreadMessageQueue() != marsMulti::comm::MessageQueue::Handler2Queue(AYNC_HANDLER)) \
{ marsMulti::comm::MessageQueue::AsyncInvoke(func, AYNC_HANDLER, msg_name); return; } \
...
if (marsMulti::comm::MessageQueue::CurrentThreadMessageQueue() != marsMulti::comm::MessageQueue::Handler2Queue(AYNC_HANDLER)) \
{ marsMulti::comm::MessageQueue::AsyncInvoke(func, AYNC_HANDLER, msg_name); return ret; } \
...
if (marsMulti::comm::MessageQueue::CurrentThreadMessageQueue() != marsMulti::comm::MessageQueue::Handler2Queue(AYNC_HANDLER)) \
{ marsMulti::comm::MessageQueue::AsyncInvoke(func, title, AYNC_HANDLER, msg_name); return ret; } \
...
if (marsMulti::comm::MessageQueue::CurrentThreadMessageQueue() != marsMulti::comm::MessageQueue::Handler2Queue(AYNC_HANDLER)) \
{ marsMulti::comm::MessageQueue::MessagePost_t postId = marsMulti::comm::MessageQueue::AsyncInvoke(func, AYNC_HANDLER, msg_name);marsMulti::comm::MessageQueue::WaitMessage(postId); return ret; } \
...
if (marsMulti::comm::MessageQueue::CurrentThreadMessageQueue() != marsMulti::comm::MessageQueue::Handler2Queue(AYNC_HANDLER)) \
{\
return marsMulti::comm::MessageQueue::WaitInvoke(func, AYNC_HANDLER, msg_name);\
}
...
{\
pre_lambda();\
auto r = marsMulti::comm::MessageQueue::WaitInvoke(func, ret, timeout, AYNC_HANDLER, msg_name);\
