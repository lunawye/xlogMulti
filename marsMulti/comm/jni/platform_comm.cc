...
#include "marsMulti/boost/ref.hpp"

#include "marsMulti/comm/thread/lock.h"
#include "marsMulti/comm/coroutine/coroutine.h"
#include "marsMulti/comm/coroutine/coro_async.h"
...
DEFINE_FIND_CLASS(KPlatformCommC2Java, "com/tencent/marsMulti/comm/PlatformComm$C2Java")
#else
...
DEFINE_FIND_STATIC_METHOD(KPlatformCommC2Java_getCurWifiInfo, KPlatformCommC2Java,
                          "getCurWifiInfo", "()Lcom/tencent/marsMulti/comm/PlatformComm$WifiInfo;")
#else
...
DEFINE_FIND_STATIC_METHOD(KPlatformCommC2Java_getCurSIMInfo, KPlatformCommC2Java, "getCurSIMInfo",
                          "()Lcom/tencent/marsMulti/comm/PlatformComm$SIMInfo;")
#else
...
#ifndef NATIVE_CALLBACK
        DEFINE_FIND_STATIC_METHOD(KPlatformCommC2Java_getAPNInfo, KPlatformCommC2Java, "getAPNInfo", "()Lcom/tencent/marsMulti/comm/PlatformComm$APNInfo;")
#else
...
DEFINE_FIND_STATIC_METHOD(KPlatformCommC2Java_wakeupLock_new, KPlatformCommC2Java, "wakeupLock_new",
                          "()Lcom/tencent/marsMulti/comm/WakerLock;")
#else
