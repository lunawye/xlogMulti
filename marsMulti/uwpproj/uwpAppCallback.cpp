...
marsMulti::app::AccountInfo uwpAppCallback::GetAccountInfo()
{
	marsMulti::app::AccountInfo info;
...
marsMulti::app::DeviceInfo uwpAppCallback::GetDeviceInfo()
{
	marsMulti::app::DeviceInfo info;
