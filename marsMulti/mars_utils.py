...
COMM_COPY_HEADER_FILES = {
            "marsMulti/comm/qm_verinfo.h": "comm",
            "marsMulti/comm/qm_autobuffer.h": "comm",
            "marsMulti/comm/qm_http.h": "comm",
            "marsMulti/comm/qm_time_utils.h": "comm",
            "marsMulti/comm/qm_strutil.h": "comm",
            "marsMulti/comm/qm_string_cast.h": "comm",
            "marsMulti/comm/qm_comm_data.h": "comm",
            "marsMulti/comm/qm_projdef.h": "comm",
            "marsMulti/comm/platform_comm.h": "comm",
            "marsMulti/comm/socket/qm_local_ipstack.h": "comm",
            "marsMulti/comm/socket/qm_nat64_prefix_util.h": "comm",
            "marsMulti/comm/qm_has_member.h" : "comm",
            "marsMulti/comm/objc/qm_scope_autoreleasepool.h": "comm",
            "marsMulti/comm/objc/qm_ThreadOperationQueue.h": "comm",
            "marsMulti/stn/stn.h": "stn",
            "marsMulti/stn/stn_logic.h": "stn",
            "marsMulti/stn/proto/stnproto_logic.h": "stn",
            "marsMulti/baseevent/base_logic.h": "baseevent",
            "marsMulti/comm/qm_xlogger/qm_preprocessor.h": "xlog",
            "marsMulti/comm/qm_xlogger/qm_xloggerbase.h": "xlog",
            "marsMulti/comm/qm_xlogger/qm_xlogger.h": "xlog",
            "marsMulti/log/qm_appender.h": "xlog",
            "marsMulti/log/qm_xlogger_interface.h": "xlog",
            "marsMulti/app/app.h": "app",
            "marsMulti/app/app_logic.h": "app",
            "marsMulti/sdt/sdt.h": "sdt",
            "marsMulti/sdt/sdt_logic.h": "sdt",
            "marsMulti/sdt/constants.h": "sdt",
            "marsMulti/sdt/netchecker_profile.h": "sdt",
            "marsMulti/stn/proto/longlink_packer.h": "stn/proto",
            }        


WIN_COPY_EXT_FILES = {
            "marsMulti/comm/platform_comm.h": "comm",
            "marsMulti/comm/windows/qm_projdef.h": "comm/windows",
            "marsMulti/comm/windows/sys/cdefs.h": "comm/windows/sys",
            "marsMulti/comm/windows/sys/time.h": "comm/windows/sys",
            "marsMulti/comm/platform_comm.h": "comm",
}
...
''' % (revision, path, url, build_time, tag)
    ...
    with open('%s/qm_verinfo.h' % version_file_path, 'wb') as f:
        f.write(contents)
        f.flush()
...
if __name__ == '__main__':
    lipo_thin_libs(u'/Users/garry/Documents/gitcode/mmnet/marsMulti/openssl/openssl_lib_iOS/libcrypto.a', u'/Users/garry/Documents/gitcode/mmnet/marsMulti/openssl/openssl_lib_iOS/libcrypto_test.a', ['x86_64', 'arm64'])
