...
extern marsMulti::comm::ProxyInfo GetProxyInfo(const std::string& _host);
...
extern double GetOsVersion();
    ...
    public:
        ...
        virtual marsMulti::comm::ProxyInfo GetProxyInfo(const std::string& _host) {return marsMulti::comm::ProxyInfo();}
