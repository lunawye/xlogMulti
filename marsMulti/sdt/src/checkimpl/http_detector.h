...
class HTTPDetector {
  ...
  private:
    ...
    marsMulti::comm::Mutex               mutex_;
    marsMulti::comm::Thread              worker_thread_;
    marsMulti::comm::SocketBreaker       breaker_;
    
    DetectEndCallBack   callback_;
    
    marsMulti::comm::DNS                 dns_;
    marsMulti::comm::DNSBreaker          dns_breaker_;
